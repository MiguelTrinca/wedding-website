...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "rsvp.kidsWelcomeTitle": "Kids Welcome!",
    "rsvp.kidsWelcome": "We'll have a professional nanny available to entertain children ages 0-12 during the celebration, so parents can enjoy the festivities worry-free.",
    "rsvp.transportationTitle": "Buses / Shuttles!",
    "rsvp.transportation": "We'll provide transportation from the hotel to the venue and back. Let us know if you would like to use this service, so that we can arrange accordingly.",
    "rsvp.foodCardTitle": "Food Restrictions!",
    "rsvp.foodCard": "Let us know if you have any food restrictions, so that we can accommodate you.",
    "rsvp.formTitle": "Please respond by filling out the form below",
    "rsvp.firstName": "First Name",
    "rsvp.nameHelp": "Please write the name that you would like to see in the sitting plan",
    ...
    "rsvp.guestCountHelp": "Number of additional guests (excluding you)",
    "rsvp.justMe" : "Just me",
  ...
  pt: {
    ...
    "rsvp.kidsWelcomeTitle": "Crianças Bem-vindas!",
    "rsvp.kidsWelcome": "Teremos uma ama profissional disponível para entreter crianças dos 0 aos 12 anos durante a celebração, para que os pais possam desfrutar das festividades sem preocupações.",
    "rsvp.transportationTitle": "Autocarros / Shuttles!",
    "rsvp.transportation": "Forneceremos transporte do hotel para o local e de volta. Digam-nos se gostariam de usar este serviço, para que possamos organizar adequadamente.",
    "rsvp.foodCardTitle": "Restrições Alimentares!",
    "rsvp.foodCard": "Digam-nos se têm alguma restrição alimentar, para que possamos acomodar-vos.",
    "rsvp.formTitle": "Por favor, respondam preenchendo o formulário abaixo",
    "rsvp.firstName": "Primeiro Nome",
    "rsvp.nameHelp": " Por favor escreva o nome que quer ver no plano das mesas",
    ...
    "honeyPot.progressMessage": "Estamos muito entusiasmoado para partilhar este dia especial contigo! A tua presença já é o melhor presente para nós, e não podemos esperar para partilhar este momento juntos.",
