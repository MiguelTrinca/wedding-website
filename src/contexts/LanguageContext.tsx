...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "activities.waterSports": "Local Delicacies",
    "activities.waterSportsDesc": "We may be biased, but there is no better queijada in the world. Try the honey cake and visit the Santo António factory in the heart of the city.",
    "activities.gardens": "Nightlife",
    "activities.gardensDesc": "To enjoy Madeira’s nightlife: nothing better than Funchal’s old town, followed by the clubs, or a poncha in Câmara de Lobos.",
    "activities.cableCar": "Miscellaneous",
    "activities.cableCarDesc": "For more relaxed (or not!) plans, we suggest a Madeira wine tasting, a cable car ride, and the famous Monte toboggan ride.",
  ...
  pt: {
    ...
    "giftSectiondescription": "A vossa presença é o melhor presente — mas se desejarem, aqui estão duas ideias.",
    ...
    "activities.beachDesc": "Sugestões : piscinas naturais do Porto Moniz, passeio de catamarã até Fajã dos Padres e claro se tiverem tempo: a maravilhosa praia da ilha dourada.",
    ...
    "activities.waterSports": "Iguarias",
    "activities.waterSportsDesc": "Somos suspeitos, mas não há melhor queijada no mundo. Prove o bolo de mel e visite a fábrica de St. António no coração da cidade.",
    "activities.gardens": "Vida noturna",
    "activities.gardensDesc": "Para aproveitar a noite madeirense: nada melhor que a zona velha do Funchal, seguida duma passagem nas discotecas, ou uma poncha na vila de Câmara de Lobos.",
    "activities.cableCar": "Diversos",
    "activities.cableCarDesc": "Para planos mais tranquilos (ou não), propomos uma prova de vinho Madeira, com um passeio de teleférico e uma descida de carros do Monte.",
    ...
    "restaurants.aVistaLocation": "Funchal, Madeira",
    "restaurants.nini": "Design Centre Nini Andrade Silva",
    "restaurants.niniDesc": "O nome diz tudo. O pequeno-almoço não fica atrás do jantar.",
    "restaurants.niniLocation": "Funchal, Madeira",  
    ...
    "transportation.carRentalDesc": "A ilha está bem equipada com inúmeras empresas de aluguer de carros. Recomendamos \"Baia Car\" um amigo que aluga carros a um ótimo preço. E claro que também pode alugar nas empresas mais comuns (Hertz, Europcar, etc.)",
    ...
    // RSVP
    "rsvp.title": "RSVP",
    "rsvp.description": "Estamos muito entusiasmados por celebrar o nosso dia convosco! A vossa presença significa muito para nós, mal podemos esperar para partilhar este momento bonito juntos. Por favor, digam-nos se vão estar presentes na nossa festa e celebração.",
    ...
    "dressCodeWomen.description": "Esta página fornece orientações para ajudar os convidados a escolher vestuário formal apropriado para o nosso dia. Queremos que todos se sintam confortáveis e elegantes, respeitando as escolhas de cores do nosso casamento.",
    ...
    "dressCodeWomen.recommended1": "Vestidos longos ou de noite",
    ...
    "dressCodeMen.description": "O noivo irá vestir um fraque como fato de casamento. Deste modo convida os convidados homens a vestirem também um fraque. Esta página fornece orientações para os convidados poderem perceber como se veste um fraque",
    "dressCodeMen.tailcoat": "Fraque para os Convidados do Noivo",
    "dressCodeMen.tailcoatDesc": "Os convidados do noivo são convidados a usar um fraque. Uma vez que o noivo vai usar um fraque ajuda a criar uma atmosfera coesa e elegante para o nosso dia especial.",
    "dressCodeMen.howToWear": "Como Usar uma fraque Tradicional",
    "dressCodeMen.tailcoatJacket": "Fraque",
    "dressCodeMen.tailcoatJacketDesc": "Um fraque formal preta, ou outra cor com caudas que se estendem abaixo da cintura nas costas.",
    ...
    "dressCodeMen.tieDesc": "Gravata preta",
    ...
    "dressCodeMen.avoidWhiteDesc": "Para honrar a noiva e manter o significado especial do branco neste dia, pedimos gentilmente que os convidados evitem usar branco, marfim, creme e tons neutros muito claros.",
    ...
    "honeyPot.description": "Como já referimos antes, o mais importante é a vossa presença. Ainda assim, caso desejem oferecer-nos algo, deixamos algumas sugestões abaixo.",
    "honeyPot.goalProgress": "Progresso do objetivo",
    "honeyPot.donate": "Oferecer",
    "honeyPot.modalTitle": "Contribuir para o nosso Pote de Mel",
    ...
    "gift.description": "A vossa presença é o maior presente de todos. Para quem desejar oferecer algo mais, criámos uma pequena lista de sugestões.",
