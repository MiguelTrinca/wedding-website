    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-3">{t("visitMadeira.title")}</h2>
          <p className="text-foreground/80 max-w-2xl mx-auto">{t("visitMadeira.description")}</p>
        </div>
