...
const cards: CardSpec[] = [
  {
    title: "Activities",
    href: "/activities",
    description: "Discover hikes, viewpoints, and ocean adventures across Madeira.",
    delayMs: 0,
    images: [
  ...
  },
  {
    title: "Restaurants",
    href: "/restaurants",
    description: "Visit our favorite restaurants of the island.",
    delayMs: 2000,
    images: [
  ...
  },
  {
    ...
    href: "/transportation",
    description: "How to get around: car rentals, buses, taxis, and tips.",
    delayMs: 1000,
    images: [
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">Visit Madeira</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Explore what to do, where to eat, and how to get around.</p>
        </div>
